...
9. `/settings/storage`、`/settings/backup`、`/settings/notifications`、`/settings/activity-types` が直接開けることを確認
10. `npx tsc --noEmit` でビルドエラーがないことを確認
11. PR では GitHub Actions の `CI` workflow が成功していることを確認
