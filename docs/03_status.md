...
- 直近の作業: Dashboard / History から Lines / History への主要 drilldown と通知 filter 境界は順次 E2E 固定済み。次は未自動化の通知設定境界や backup/restore 後の表示状態を、小さい PR 単位で追加確認する。
...
1. 通知設定境界や backup/restore 後の表示状態のうち、実利用で壊れると発見が遅いものを1つ選び、E2E と docs を小さい PR で追加する
