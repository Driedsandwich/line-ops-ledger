...
1. History の今後のイベント MNP drilldown E2E PR の `check` / `build` / `test:e2e` / `audit` と GitHub Actions を通し、共通イベントフィードから Lines の MNP 情報への導線に回帰がないことを確認する
