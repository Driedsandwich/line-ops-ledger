...
- 直近の作業: Dashboard から Lines / History への主要 drilldown は順次 E2E 固定済み。次は未自動化の Dashboard 導線や通知理由境界を、小さい PR 単位で追加確認する。
...
1. Dashboard からの残り drilldown や通知理由境界のうち、実利用で壊れると発見が遅いものを1つ選び、E2E と docs を小さい PR で追加する
