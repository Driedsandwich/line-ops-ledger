...
1. Dashboard の契約中 filter drilldown E2E PR の `check` / `build` / `test:e2e` / `audit` と GitHub Actions を通し、Dashboard から Lines への filter 初期化に回帰がないことを確認する
