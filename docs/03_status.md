...
1. Dashboard の月額費用 CTA E2E PR の `check` / `build` / `test:e2e` / `audit` と GitHub Actions を通し、Monthly Cost から Lines への導線に回帰がないことを確認する
