...
1. Dashboard の費用/特典 CTA E2E PR の `check` / `build` / `test:e2e` / `audit` と GitHub Actions を通し、Net Balance から Lines への導線に回帰がないことを確認する
