...
1. 通知無効時の通知理由 query 境界 E2E PR の `check` / `build` / `test:e2e` / `audit` と GitHub Actions を通し、通知無効状態で理由 query が残っても表示が破綻しないことを確認する
